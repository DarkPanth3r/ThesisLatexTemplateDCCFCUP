...
%---------------------------------------
    ...
    No caso em que o pdf gerado ocupe uma página A4 inteira (por exemplo nas 
    ferramentas do MS Office) podem usar o 
    \texttt{\href{https://www.ctan.org/pkg/pdfcrop?lang=en}{pdfcrop}} no pdf 
    gerado. Este comando está disponível na maior parte das distribuições de 
    \LaTeX.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{itemize}
   \item usar o \texttt{\textasciitilde{}} para ligar as referências, evita a 
      possível mudança de página: ex.: \emph{como o Brandão 
      refere\textasciitilde\textbackslash{}cite\{bran99\}}
     \begin{itemize}
        \item também se deve seguir a mesma regra para 
           \texttt{\textbackslash{}ref}, unidades de dados, nº de standard (ex.: 
           \emph{IEEE\textasciitilde802.11}).
     \end{itemize}
